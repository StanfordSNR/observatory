...
def run(args):
    ...
    base_cmd = [console, 'cloud', '--schemes', 'bbr default_tcp ledbat pcc quic scream webrtc sprout taova vegas verus copa fillp indigo indigo_no_calibration vivace_latency vivace_loss vivace_lte', '--run-times', '10']

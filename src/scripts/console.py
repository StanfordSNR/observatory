...
class Console(object):
    ...
    def analyze(self, d):
        analyze_cmd = '~/pantheon/analysis/analyze.py --schemes "bbr default_tcp ledbat pcc quic scream webrtc sprout taova vegas verus copa fillp indigo_1_32 vivace pcc_experimental" --data-dir %s >> %s 2>&1'

...
if hostname in host_to_port:
    ...
    # Could do: print ( hash(hostname) % 63499 ) + 2000 # chose port between 2000, 65499 based on the first 64 bits of the md5sum of the case-insensitive hostname (63499 is a prime number)
